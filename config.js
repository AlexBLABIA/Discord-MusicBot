module.exports = {
	...
	adminId: "979102302529007657", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "", //- Bot's Token
	clientId: process.env.clientId || "1436877938632032348", //- ID of the bot
	clientSecret: process.env.clientSecret || "SVKQihGDZXhNx14rQgfuVazlYqsroMay", //- Client Secret of the bot
	...
	website: "https://discord-musicbot-ytoa.onrender.com", //- without the / at the end
	// You need a lavalink server for this bot to work!!!!
	// Lavalink server; public lavalink -> https://lavalink-list.darrennathanael.com/; create one yourself -> https://darrennathanael.com/post/how-to-lavalink
	nodes: [
		{
			identifier: "Muzykant lavalink v4", //- Used for indentifier in stats commands.
			password: "https://discord.gg/v6sdrD9kPh", //- The password of the lavalink server.
			host: "lavalink_v4.muzykant.xyz", //- The host name or IP of the lavalink server.
