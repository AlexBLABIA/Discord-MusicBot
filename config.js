module.exports = {
	...
	nodes: [
		{
			identifier: "AjieDev-V4", //- Used for indentifier in stats commands.
			...
			retryAmount: 443, //- The amount of times to retry connecting to the node if connection got dropped.
